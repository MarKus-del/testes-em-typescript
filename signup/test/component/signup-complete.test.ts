...
let completedNotificationSignup: SinonStub;
...
describe("Signup complete", () => {
    ...
    beforeEach(() => {
        ...
        completedNotificationSignup = stub(signupNotifier, "complete");
    });
    ...
    it("send a notification when a signup is completed", async () => {
        ...
        await signupComplete(token);
        expect(completedNotificationSignup).to.have.been.calledOnce;
     });
});
